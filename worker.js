...
<style>
*{box-sizing:border-box}body{font-family:Arial,sans-serif;margin:0;padding:8px;background:#eef2f6;color:#172033}.app{max-width:760px;margin:auto}.top,.tools{display:flex;gap:6px;align-items:center}.top{justify-content:space-between;padding:5px 2px}.tabs{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin:7px 0}.tab,.b{height:40px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;font-weight:800}.tab.on,.b{background:#172033;color:#fff}.tools input{height:40px;min-width:0;flex:1;border:1px solid #cbd5e1;border-radius:10px;padding:0 10px;font-size:16px}.status{font-size:11px;color:#64748b;margin:5px 2px}.guide{font-size:14px;font-weight:800;background:#fff;border:1px solid #cbd5e1;border-radius:10px;padding:9px 11px;margin:6px 0;box-shadow:0 1px 3px #0001}.box{overflow-x:auto;background:#fff;border:1px solid #d7dee8;border-radius:12px;box-shadow:0 2px 8px #0001}.row{display:grid;gap:3px;align-items:center;padding:5px;border-bottom:1px solid #e5e7eb}.pre{grid-template-columns:30px minmax(130px,1fr) 58px}.post{grid-template-columns:26px 88px 30px repeat(5,38px) 58px;min-width:465px;transition:background .2s}.post.empty{background:#bbf7d0}.post.loading{background:#fde68a}.post.full{background:#fca5a5}.num{text-align:center;font-size:12px;font-weight:900}.sel,.dir,.slot,.act{height:34px;border:1px solid #b8c2d0;border-radius:7px;background:#fff}.sel{width:100%;font-size:12px;font-weight:700}.dir{font-size:18px}.slot{font-size:15px;font-weight:900}.slot.on{background:#172033;color:#fff;border-color:#172033}.slot.blocked{background:#e5e7eb;color:#555;border-style:dashed}.actions{display:grid;grid-template-rows:1fr 1fr;gap:3px}.act{height:24px;font-size:9px;font-weight:800;padding:0 2px}.act.cut{background:#fff3cd}.act.open{background:#dcfce7}.hide{display:none}.cnt{font-size:13px;font-weight:800}.head{font-size:9px;color:#64748b;font-weight:800;text-align:center;background:#f8fafc}.toast{position:sticky;bottom:8px;margin:8px auto 0;background:#172033;color:#fff;padding:8px 11px;border-radius:8px;font-size:11px;width:max-content;opacity:0}.toast.on{opacity:1}dialog{border:0;border-radius:12px}dialog input{height:40px;font-size:16px}</style>
</head>
<body>
<div class="app">
